 ...
 *
 */
package net.mcreator.techodysseybeyondthelimits;
...
@Mod("tech_odyssey_beyond_the_limits")
public class TechOdysseyBeyondTheLimitsMod {
	public static final Logger LOGGER = LogManager.getLogger(TechOdysseyBeyondTheLimitsMod.class);
	public static final String MODID = "tech_odyssey_beyond_the_limits";

	public TechOdysseyBeyondTheLimitsMod() {
		MinecraftForge.EVENT_BUS.register(this);
		TechOdysseyBeyondTheLimitsModTabs.load();
