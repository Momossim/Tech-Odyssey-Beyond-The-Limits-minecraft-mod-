...
public class PeridotItem extends TechOdysseyBeyondTheLimitsModElements.ModElement {
	@ObjectHolder("tech_odyssey_beyond_the_limits:peridot")
	public static final Item block = null;

	public PeridotItem(TechOdysseyBeyondTheLimitsModElements instance) {
		super(instance, 64);
	}
