...
public class PeridotAxeItem extends TechOdysseyBeyondTheLimitsModElements.ModElement {
	@ObjectHolder("tech_odyssey_beyond_the_limits:peridot_axe")
	public static final Item block = null;

	public PeridotAxeItem(TechOdysseyBeyondTheLimitsModElements instance) {
		super(instance, 22);
	}
