...
public class SapphireShovelItem extends TechOdysseyBeyondTheLimitsModElements.ModElement {
	@ObjectHolder("tech_odyssey_beyond_the_limits:sapphire_shovel")
	public static final Item block = null;

	public SapphireShovelItem(TechOdysseyBeyondTheLimitsModElements instance) {
		super(instance, 94);
	}
