...
public class SapphireHoeItem extends TechOdysseyBeyondTheLimitsModElements.ModElement {
	@ObjectHolder("tech_odyssey_beyond_the_limits:sapphire_hoe")
	public static final Item block = null;

	public SapphireHoeItem(TechOdysseyBeyondTheLimitsModElements instance) {
		super(instance, 28);
	}
