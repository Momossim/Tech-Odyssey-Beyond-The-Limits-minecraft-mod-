...
public class SapphireArmorItem extends TechOdysseyBeyondTheLimitsModElements.ModElement {
	@ObjectHolder("tech_odyssey_beyond_the_limits:sapphire_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("tech_odyssey_beyond_the_limits:sapphire_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("tech_odyssey_beyond_the_limits:sapphire_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("tech_odyssey_beyond_the_limits:sapphire_armor_boots")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "tech_odyssey_beyond_the_limits:textures/models/armor/sapphire_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
